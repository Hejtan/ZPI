...
import static Enumerators.CRUDAmount.SINGLE;
import static Enumerators.CRUDAmount.MANY;
import static Enumerators.CUDType.CREATE;
import static Enumerators.CUDType.UPDATE;
import static Enumerators.CUDType.DELETE;
...
public class MongoDBConnection {
     ...
     */
    public MongoDBConnection(String user_name, String user_password, String database_name) {
     ...
     */
    public ArrayList<User> UserRead(CRUDAmount amount, Bson filters) {
     ...
     */
    public ArrayList<User> UserRead(Bson filters) {
        return UserRead(SINGLE, filters);
    }
    ...
    public boolean UserCUD(User[] users) {
        return UserCUD(CREATE, SINGLE, null, users, null);
    }
    ...
    public boolean UserCUD(Bson[] filters) {
        return UserCUD(DELETE, SINGLE, filters, null, null);
    }
    ...
    public boolean UserCUD(Bson[] filters, Bson[] update_fields) {
        return UserCUD(UPDATE, SINGLE, filters, null, update_fields);
    }
    ...
    public boolean UserCUD(CRUDAmount amount, User[] users) {
        return UserCUD(CREATE, amount, null, users, null);
    }
    ...
    public boolean UserCUD(CRUDAmount amount, Bson[] filters) {
        return UserCUD(DELETE, amount, filters, null, null);
    }
    ...
    public boolean UserCUD(CRUDAmount amount, Bson[] filters, Bson[] update_fields) {
        return UserCUD(UPDATE, amount, filters, null, update_fields);
    }
     ...
     */
    public ArrayList<Event> EventRead(CRUDAmount amount, Bson filters) {
     ...
     */
    public ArrayList<Event> EventRead(Bson filters) {
        return EventRead(SINGLE, filters);
    }
    ...
    public boolean EventCUD(Event[] events) {
        return EventCUD(CREATE, SINGLE, null, events, null);
    }
    ...
    public boolean EventCUD(Bson[] filters) {
        return EventCUD(DELETE, SINGLE, filters, null, null);
    }
    ...
    public boolean EventCUD(Bson[] filters, Bson[] update_fields) {
        return EventCUD(UPDATE, SINGLE, filters, null, update_fields);
    }
    ...
    public boolean EventCUD(CRUDAmount amount, Event[] events) {
        return EventCUD(CREATE, amount, null, events, null);
    }
    ...
    public boolean EventCUD(CRUDAmount amount, Bson[] filters) {
        return EventCUD(DELETE, amount, filters, null, null);
    }
    ...
    public boolean EventCUD(CRUDAmount amount, Bson[] filters, Bson[] update_fields) {
        return EventCUD(UPDATE, amount, filters, null, update_fields);
    }
     ...
     */
    public ArrayList<Category> CategoryRead(CRUDAmount amount, Bson filters) {
     ...
     */
    public ArrayList<Category> CategoryRead(Bson filters) {
        return CategoryRead(SINGLE, filters);
    }
    ...
    public boolean CategoryCUD(Category[] categories) {
        return CategoryCUD(CREATE, SINGLE, null, categories, null);
    }
    ...
    public boolean CategoryCUD(Bson[] filters) {
        return CategoryCUD(DELETE, SINGLE, filters, null, null);
    }
    ...
    public boolean CategoryCUD(Bson[] filters, Bson[] update_fields) {
        return CategoryCUD(UPDATE, SINGLE, filters, null, update_fields);
    }
    ...
    public boolean CategoryCUD(CRUDAmount amount, Category[] categories) {
        return CategoryCUD(CREATE, amount, null, categories, null);
    }
    ...
    public boolean CategoryCUD(CRUDAmount amount, Bson[] filters) {
        return CategoryCUD(DELETE, amount, filters, null, null);
    }
    ...
    public boolean CategoryCUD(CRUDAmount amount, Bson[] filters, Bson[] update_fields) {
        return CategoryCUD(UPDATE, amount, filters, null, update_fields);
    }
    ...
    private boolean updateUsers(Bson[] update_fields, Bson[] filters, MongoCollection<User> collection) {
        if (update_fields.length == filters.length) {
